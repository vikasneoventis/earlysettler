...
class InstallSchema implements InstallSchemaInterface
{
    ...
    const SCHEMA_IMAGE = 'magestore_storelocator_image';
    const SCHEMA_SCHEDULE = 'magestore_storelocator_schedule';
    const SCHEMA_TAG = 'magestore_storelocator_tag';
    const SCHEMA_SPECIALDAY = 'magestore_storelocator_specialday';
    const SCHEMA_HOLIDAY = 'magestore_storelocator_holiday';
    const SCHEMA_STORE_TAG = 'magestore_storelocator_store_tag';
    const SCHEMA_STORE_HOLIDAY = 'magestore_storelocator_store_holiday';
    const SCHEMA_STORE_SPECIALDAY = 'magestore_storelocator_store_specialday';
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        /*
         * Create table magestore_storelocator_schedule
         */
        ...
        /*
         * End create table magestore_storelocator_schedule
         */
        /*
         * Create table magestore_storelocator_store
         */
        $table = $installer->getConnection()->newTable(
        ...
        $installer->getConnection()->createTable($table);
        /*
         * End create table magestore_storelocator_store
         */

        /*
         * Create table magestore_storelocator_tag
         */
        $table = $installer->getConnection()->newTable(
        ...
        $installer->getConnection()->createTable($table);
        /*
         * End create table magestore_storelocator_tag
         */

        /*
         * Create table magestore_storelocator_store_tag
         */
        $table = $installer->getConnection()->newTable(
        ...
        $installer->getConnection()->createTable($table);
        /*
         * End create table magestore_storelocator_store_tag
         */

        /*
         * Create table magestore_storelocator_holiday
         */
        $table = $installer->getConnection()->newTable(
        ...
        $installer->getConnection()->createTable($table);
        /*
         * End create table magestore_storelocator_holiday
         */

        /*
         * Create table magestore_storelocator_store_holiday
         */
        $table = $installer->getConnection()->newTable(
        ...
        $installer->getConnection()->createTable($table);
        /*
         * End create table magestore_storelocator_store_holiday
         */

        /*
         * Create table magestore_storelocator_specialday
         */
        $table = $installer->getConnection()->newTable(
        ...
        $installer->getConnection()->createTable($table);
        /*
         * End create table magestore_storelocator_specialday
         */

        /*
         * Create table magestore_storelocator_store_specialday
         */
        $table = $installer->getConnection()->newTable(
        ...
        $installer->getConnection()->createTable($table);
        /*
         * End create table magestore_storelocator_store_specialday
         */

        /*
         * Create table magestore_storelocator_image
         */
        $table = $installer->getConnection()->newTable(
            $installer->getTable(self::SCHEMA_IMAGE)
        )->addColumn(
        ...
        $installer->getConnection()->createTable($table);
        /*
         * End create table magestore_storelocator_image
         */
