...
class Rate extends AbstractModel
{
    ...
    {
        $this->_init('Amasty\ShippingTableRates\Model\Resource\Rate');
    }
    ...
    {
        /**
         * @var \Amasty\ShippingTableRates\Model\Resource\Rate $resource
         */
        $resource = $this->_objectManager->get('Amasty\ShippingTableRates\Model\Resource\Rate');
    ...
    public function findBy($request, $collection)
    {
        ...
        /** @var \Amasty\ShippingTableRates\Model\Resource\Rate\Collection $allRates */
