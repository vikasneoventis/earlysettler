...
class MassDelete extends \Magento\Backend\App\Action
{
    public function execute()
    {
        ...
        try {
            /**
             * @var $collection \Amasty\ShippingTableRates\Model\Resource\Method\Collection
             */
            $collection = $this->_objectManager->create('Amasty\ShippingTableRates\Model\Resource\Method\Collection');
