...
class Factory
{
     ...
     */
    protected $_typeMap = [
        self::MODEL_SPECIALDAY => 'Magestore\Storelocator\Model\Specialday',
        self::MODEL_HOLIDAY => 'Magestore\Storelocator\Model\Holiday',
        self::MODEL_TAG => 'Magestore\Storelocator\Model\Tag',
        self::MODEL_SCHEDULE => 'Magestore\Storelocator\Model\Schedule',
    ];
    ...
    public function create($type, array $arguments = [])
    {
        ...
        if (!$instance instanceof \Magestore\Storelocator\Model\AbstractModelManageStores) {
            throw new \InvalidArgumentException(
                get_class($instance)
                . ' isn\'t instance of \Magestore\Storelocator\Model\AbstractModelManageStores'
            );
        }
