 ...
 */
namespace Magestore\Storelocator\Block\Adminhtml\Specialday\Edit\Tab;
...
class GeneralTab extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            'time_open',
            'Magestore\Storelocator\Block\Adminhtml\Widget\Form\Element\Time',
            [
                'name' => 'time_open',
                'label' => __('Open Time'),
                'title' => __('Open Time'),
    ...
    {
        return $this->_coreRegistry->registry('storelocator_specialday');
    }
