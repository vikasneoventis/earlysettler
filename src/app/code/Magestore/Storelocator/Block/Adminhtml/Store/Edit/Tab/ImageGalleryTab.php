...
class ImageGalleryTab extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            'gallery',
            'Magestore\Storelocator\Block\Adminhtml\Widget\Form\Element\Gallery',
            [
                'label' => __('Image Gallery'),
                'title' => __('Image Gallery'),
            ]
        )->setRenderer(
            $this->getLayout()->createBlock('Magestore\Storelocator\Block\Adminhtml\Widget\Form\Renderer\Gallery')
        );
